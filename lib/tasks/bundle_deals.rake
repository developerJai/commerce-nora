namespace :bundle_deals do
  desc "Seed bundle deals data (safe to run multiple times, uses find_or_create_by)"
  task seed: :environment do
    puts "Seeding bundle deals..."

    # Wedding Essential Set
    ...
    puts "  ✓ Complete Jewelry Set"

    puts ""
    puts "Bundle deals seeding complete!"
    puts "Total bundle deals: #{BundleDeal.count}"
  end
end
