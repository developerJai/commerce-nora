module Admin
  class StoreSettingsController < BaseController
    ...
    def update
      ...
      company_params = params.fetch(:store_setting, {}).permit(:gst_number, :company_address, :company_phone, :contact_email, :enable_coupons, :enable_multi_vendor_coupons, :free_delivery_min_amount, :delivery_charge_amount, :youtube_url, :instagram_url, :facebook_url, :twitter_url, :banner_bg_color, :banner_text_color, :banner_accent_color)
